...
std::ostream& operator<<(std::ostream& oss, const I3WimpParams& d){
  oss << "[ I3WimpParams ::" << std::endl
      << "     Source : " << d.GetSourceString() << std::endl
      << " Mass (GeV) : " << d.GetMass()/I3Units::GeV << std::endl
      << "    Channel : " << d.GetChannel() << std::endl
      << "  Nu_Weight : " << d.GetNuWeight() << std::endl
      << " Lep_Weight : " << d.GetLepWeight() << std::endl
      << " Had_Weight : " << d.GetHadWeight() << std::endl
      << "       Vgen : " << d.GetVgen() << std::endl
      << "      Aproj : " << d.GetAproj() << std::endl
      << "       Time : " << d.GetTime().GetUTCString() << std::endl
      << "]";
  return oss;
}
